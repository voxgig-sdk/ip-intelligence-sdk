...
func registerSDKWords(r *eng.Registry, client *sdk.IpIntelligenceSDK) {
...
func runOp(client *sdk.IpIntelligenceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
