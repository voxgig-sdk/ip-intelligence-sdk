...
local IpIntelligenceSDK = {}
IpIntelligenceSDK.__index = IpIntelligenceSDK
...
IpIntelligenceSDK._make_feature = _make_feature


function IpIntelligenceSDK.new(options)
  local self = setmetatable({}, IpIntelligenceSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function IpIntelligenceSDK:options_map()
...
function IpIntelligenceSDK:get_utility()
  return Utility.copy(self._utility)
end


function IpIntelligenceSDK:get_root_ctx()
  return self._rootctx
end


function IpIntelligenceSDK:prepare(fetchargs)
...
function IpIntelligenceSDK:direct(fetchargs)
...
-- by passing it.
function IpIntelligenceSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function IpIntelligenceSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "IpIntelligenceSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function IpIntelligenceSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = IpIntelligenceSDK.new(sdkopts)
  sdk.mode = "test"
