# IpIntelligence Lua SDK

The Lua SDK for the IpIntelligence API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:IpIntelligence(nil):load(
  { id = "test01" }, nil
)
...
```
lua/
├── ip-intelligence_sdk.lua    -- Main SDK module
...
The main module (`ip-intelligence_sdk`) exports the SDK constructor
