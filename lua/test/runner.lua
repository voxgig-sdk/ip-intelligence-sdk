...
function runner.env_override(m)
  local live = runner.getenv("IPINTELLIGENCE_TEST_LIVE")
  local override = runner.getenv("IPINTELLIGENCE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IPINTELLIGENCE_TEST_EXPLAIN")
