...
describe("UsageDirect", function()
  it("should direct-load-usage", function()
    local setup = usage_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-usage", setup.live and "live" or "unit")
...
function usage_direct_setup(mockres)
