...
type Args struct {
	Entity string         `json:"entity" jsonschema:"api | usage"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IpIntelligenceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-intelligence_list",
		Description: "List records from IpIntelligence. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-intelligence_load",
		Description: "Load a single record from IpIntelligence. " +
...
func runOp(client *sdk.IpIntelligenceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IpIntelligenceSDK, name string) (sdk.IpIntelligenceEntity, error) {
