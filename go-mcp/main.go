// Command IpIntelligence-mcp is an MCP server exposing the IpIntelligence
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IpIntelligence_list  — list records of an entity
//	IpIntelligence_load  — load a single record of an entity
//
