...
The PHP SDK for the IpIntelligence API — an entity-oriented client using PHP conventions.
...
## Install
```bash
composer require voxgig-sdk/ip-intelligence
```
...
```
php/
├── ipintelligence_sdk.php          -- Main SDK class
