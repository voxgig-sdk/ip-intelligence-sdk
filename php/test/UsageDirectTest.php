...
class UsageDirectTest extends TestCase
{
    public function test_direct_load_usage(): void
    {
        $setup = usage_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-usage", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
