...
// IpIntelligence SDK pipeline test
//
...
{
    private static function utility(): IpIntelligenceUtility
    {
        return new IpIntelligenceUtility();
    }
    ...
    private static function ctx(array $over = []): IpIntelligenceContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IpIntelligenceContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IpIntelligenceOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IpIntelligenceError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IpIntelligenceOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IpIntelligenceMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IpIntelligenceOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IpIntelligenceMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IpIntelligenceOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IpIntelligenceMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpIntelligenceSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IpIntelligenceMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IpIntelligenceResponse([]),
            'result' => new IpIntelligenceResult([]),
        ]);
        [, $err] = IpIntelligenceMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new IpIntelligenceSpec([]),
            'response' => null,
            'result' => new IpIntelligenceResult([]),
        ]);
        [, $err] = IpIntelligenceMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IpIntelligenceSpec(['step' => 's']),
            'response' => new IpIntelligenceResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IpIntelligenceResult([]),
        ]);
        [, $err] = IpIntelligenceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IpIntelligenceSpec(['step' => 's']),
            'response' => new IpIntelligenceResponse(self::resp(200, ['v' => 1])),
            'result' => new IpIntelligenceResult([]),
        ]);
        [, $err] = IpIntelligenceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IpIntelligenceSpec(['step' => 's']),
            'response' => new IpIntelligenceResponse(self::resp(200, ['v' => 2])),
            'result' => new IpIntelligenceResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IpIntelligenceMakeResponse::call($ctx);
    ...
    {
        $preset = new IpIntelligenceResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IpIntelligenceSpec([]),
            'response' => new IpIntelligenceResponse([]),
            'result' => new IpIntelligenceResult([]),
        ...
        [$got, $err] = IpIntelligenceMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IpIntelligenceResult([])]);
        [, $err] = IpIntelligenceMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IpIntelligenceSpec([]), 'result' => null]);
        [, $err] = IpIntelligenceMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpIntelligenceSpec(['step' => 's']),
            'result' => new IpIntelligenceResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IpIntelligenceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpIntelligenceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpIntelligenceSpec(['step' => 's']),
            'result' => new IpIntelligenceResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IpIntelligenceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpIntelligenceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpIntelligenceResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IpIntelligenceSpec([]),
            'result' => new IpIntelligenceResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IpIntelligenceMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpIntelligenceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IpIntelligenceError('boom', 'boom');
        $utility->fetcher = function (IpIntelligenceContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpIntelligenceSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IpIntelligenceMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IpIntelligenceContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IpIntelligenceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IpIntelligenceResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        IpIntelligenceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IpIntelligenceContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpIntelligenceSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IpIntelligenceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IpIntelligenceResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IpIntelligenceSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IpIntelligenceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IpIntelligenceMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IpIntelligenceMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IpIntelligenceResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IpIntelligenceDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IpIntelligenceResult(['ok' => false])]);
        $this->expectException(IpIntelligenceError::class);
        IpIntelligenceDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IpIntelligenceResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IpIntelligenceMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        IpIntelligenceMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IpIntelligenceBaseFeature();
        $b = new IpIntelligenceBaseFeature();
        IpIntelligenceFeatureAdd::call($ctx, $a);
        IpIntelligenceFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IpIntelligenceBaseFeature
    {
        $f = new IpIntelligenceBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IpIntelligenceFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IpIntelligenceContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IpIntelligenceSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpIntelligencePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        IpIntelligencePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IpIntelligenceResponse(['headers' => null]),
            'result' => new IpIntelligenceResult([]),
        ]);
        IpIntelligenceResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        IpIntelligenceResultBody::call($ctx);
