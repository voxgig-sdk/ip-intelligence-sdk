...
// IpIntelligence SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpIntelligenceSDK::test)
...
{
    private const SDK_CLASS = 'IpIntelligenceSDK';
    ...
    private const SDK_BASE = 'ipintelligence_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ipintelligence_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
