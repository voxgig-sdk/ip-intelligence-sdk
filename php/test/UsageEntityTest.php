...
class UsageEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IPINTELLIGENCE_TEST_USAGE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        [$usage_ref01_data_dt0_loaded, $err] = $usage_ref01_ent->load($usage_ref01_match_dt0, null);
        $this->assertNull($err);
...
function usage_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IPINTELLIGENCE_TEST_USAGE_ENTID");
