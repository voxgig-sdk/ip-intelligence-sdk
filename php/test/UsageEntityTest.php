...
class UsageEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IP_INTELLIGENCE_TEST_USAGE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function usage_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IP_INTELLIGENCE_TEST_USAGE_ENTID");
    ...
    if ($env["IP_INTELLIGENCE_TEST_LIVE"] === "TRUE") {
        ...
        $client = new IpIntelligenceSDK(Helpers::to_map($merged_opts));
    }
