...
// IpIntelligence SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IpIntelligenceMakeRequest
{
    public static function call(IpIntelligenceContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IpIntelligenceResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IpIntelligenceResponse($fetched);
        } else {
