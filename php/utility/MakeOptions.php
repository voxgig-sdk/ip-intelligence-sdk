...
// IpIntelligence SDK utility: make_options

class IpIntelligenceMakeOptions
{
    ...
    public static function call(IpIntelligenceContext $ctx): array
    {
        ...
        //
        // `IpIntelligenceSchema::optspec()` is built from the model:
        ...
        $optspec = IpIntelligenceSchema::optspec();
