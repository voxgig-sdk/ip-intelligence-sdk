...
// IpIntelligence SDK utility: fetcher

class IpIntelligenceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpIntelligenceSDK/1.0)';
    ...
    public static function call(IpIntelligenceContext $ctx, string $fullurl, array $fetchdef): array
    {
