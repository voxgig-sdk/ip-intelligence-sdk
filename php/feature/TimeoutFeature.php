...
// IpIntelligence SDK timeout feature
...
class IpIntelligenceTimeoutFeature extends IpIntelligenceBaseFeature
{
    ...
    private function _with_timeout(IpIntelligenceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpIntelligenceContext $_ctx, float $ms): void
    {
        $client = $this->client;
