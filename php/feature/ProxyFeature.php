...
// IpIntelligence SDK proxy feature
...
class IpIntelligenceProxyFeature extends IpIntelligenceBaseFeature
{
    ...
    public function init(IpIntelligenceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpIntelligenceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
