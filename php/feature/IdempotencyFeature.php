...
// IpIntelligence SDK idempotency feature
...
class IpIntelligenceIdempotencyFeature extends IpIntelligenceBaseFeature
{
    ...
    private function _mutating(IpIntelligenceContext $ctx): bool
    {
