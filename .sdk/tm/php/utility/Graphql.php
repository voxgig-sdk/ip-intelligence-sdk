...
// IpIntelligence SDK utility: graphql
//
...
class IpIntelligenceGraphql
{
    ...
    // equivalent.
    public static function body(IpIntelligenceContext $ctx): mixed
    {
    ...
    public static function errors(IpIntelligenceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
