...
// IpIntelligence SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = IpIntelligenceOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(IpIntelligenceOmni::structfix($now, Struct::undef()))
                        !== json_encode(IpIntelligenceOmni::structfix($val, Struct::undef()))) {
