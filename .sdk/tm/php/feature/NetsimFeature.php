...
// IpIntelligence SDK netsim feature
...
class IpIntelligenceNetsimFeature extends IpIntelligenceBaseFeature
{
    ...
    private function _simulate(IpIntelligenceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpIntelligenceContext $ctx, array $applied): void
    {
        $client = $this->client;
