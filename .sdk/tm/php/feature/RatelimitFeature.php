...
// IpIntelligence SDK ratelimit feature
...
class IpIntelligenceRatelimitFeature extends IpIntelligenceBaseFeature
{
    ...
    private function _acquire(IpIntelligenceContext $ctx): void
    {
    ...
    private function _track(IpIntelligenceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
