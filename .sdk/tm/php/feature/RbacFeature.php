...
// IpIntelligence SDK rbac feature
...
class IpIntelligenceRbacFeature extends IpIntelligenceBaseFeature
{
    ...
    private function _required(IpIntelligenceContext $ctx): ?string
    {
    ...
    private function _reject(IpIntelligenceContext $ctx, string $required): void
    {
    ...
    private function _track(IpIntelligenceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
