...
// IpIntelligence SDK clienttrack feature
...
class IpIntelligenceClienttrackFeature extends IpIntelligenceBaseFeature
{
    ...
    public function PostConstruct(IpIntelligenceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpIntelligence-SDK';
