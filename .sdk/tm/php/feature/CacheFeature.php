...
// IpIntelligence SDK cache feature
...
class IpIntelligenceCacheFeature extends IpIntelligenceBaseFeature
{
    ...
    private function _through(IpIntelligenceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
