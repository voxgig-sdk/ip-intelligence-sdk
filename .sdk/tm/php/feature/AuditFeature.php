...
// IpIntelligence SDK audit feature
...
class IpIntelligenceAuditFeature extends IpIntelligenceBaseFeature
{
    ...
    private function _emit(IpIntelligenceContext $ctx, string $outcome): void
    {
