...
// IpIntelligence SDK utility type

class IpIntelligenceUtility
{
    ...
    public static function copy(IpIntelligenceUtility $src): IpIntelligenceUtility
    {
        $u = new IpIntelligenceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
