...
from projectname_sdk.core.control import IpIntelligenceControl
...
class IpIntelligenceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = IpIntelligenceControl()
        ...
        if isinstance(sp, IpIntelligenceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IpIntelligenceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IpIntelligenceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return IpIntelligenceOperation({})
    ...
    def make_error(self, code, msg):
        return IpIntelligenceError(code, msg, self)
