...
|---|---|---|
| `ts/` | @voxgig-sdk/ip-intelligence-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ip-intelligence-sdk \
      --repository voxgig-sdk/ip-intelligence-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ip-intelligence-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ip-intelligence-sdk --id=<id>` removes it.
