...
func NewUsageEntity(client *core.IpIntelligenceSDK, entopts map[string]any) *UsageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UsageEntity) GetName() string { return e.name }
...
func (e *UsageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UsageEntity) Deleted() bool {
	return e.deleted
}


func (e *UsageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUsageEntity(e.client, opts)
}

func (e *UsageEntity) Data(args ...any) any {
...
func (e *UsageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Usage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UsageEntity) DataTyped(data ...Usage) Usage {
	if len(data) > 0 {
		return typedFrom[Usage](e.Data(asMap(data[0])))
	}
	return typedFrom[Usage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Usage (all fields
// optional at the wire level).
func (e *UsageEntity) MatchTyped(match ...Usage) Usage {
	if len(match) > 0 {
		return typedFrom[Usage](e.Match(asMap(match[0])))
	}
	return typedFrom[Usage](e.Match())
}
...
func (e *UsageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UsageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UsageLoadMatch and returns an Usage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UsageEntity) LoadTyped(reqmatch UsageLoadMatch, ctrl map[string]any) (Usage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Usage{}, err
	}
	return typedFrom[Usage](res), nil
}



func (e *UsageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UsageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UsageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UsageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UsageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
