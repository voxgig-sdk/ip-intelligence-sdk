...
func (sdk *IpIntelligenceSDK) OptionsMap() map[string]any {
...
func (sdk *IpIntelligenceSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IpIntelligenceSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IpIntelligenceSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpIntelligenceSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IpIntelligenceSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IpIntelligenceSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IpIntelligenceSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IpIntelligenceSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpIntelligenceSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IpIntelligenceSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *IpIntelligenceSDK {
	...
	sdk := NewIpIntelligenceSDK(sdkopts)
	sdk.Mode = "test"
