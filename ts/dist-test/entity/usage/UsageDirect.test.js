...
(0, node_test_1.describe)('UsageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IpIntelligenceSDK({
    ...
    (0, node_test_1.test)('direct-load-usage', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-usage', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IP_INTELLIGENCE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IpIntelligenceSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.IP_INTELLIGENCE_APIKEY,
        }));
        let idmap = env['IP_INTELLIGENCE_TEST_USAGE_ENTID'];
    ...
    const client = new __1.IpIntelligenceSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=UsageDirect.test.js.map