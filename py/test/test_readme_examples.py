# IpIntelligence SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpIntelligenceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpIntelligenceSDK(...) and IpIntelligenceSDK.test(...) become
#      IpIntelligenceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipintelligence_sdk"
_SDK_CLASS = "IpIntelligenceSDK"
