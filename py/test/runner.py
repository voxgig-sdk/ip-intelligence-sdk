...
class IpIntelligenceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpIntelligenceTestRunner.getenv("IPINTELLIGENCE_TEST_LIVE")
        override = IpIntelligenceTestRunner.getenv("IPINTELLIGENCE_TEST_OVERRIDE")
        ...
        explain = IpIntelligenceTestRunner.getenv("IPINTELLIGENCE_TEST_EXPLAIN")
