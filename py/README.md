# IpIntelligence Python SDK



The Python SDK for the IpIntelligence API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/ip-intelligence-sdk/releases)) or
...
| --- | --- | --- |
| `asn_handle` | `str` | Network operator name/handle |
...
| `metadata` | `dict` | Additional contextual information about the IP, structure varies based on classifications |
...
| Field | Type | Description |
| --- | --- | --- |
| `account_level` | `str` | Account tier level |
...
| `next_reset` | `str` | ISO 8601 timestamp when the usage counter resets |
...
```
py/
├── ipintelligence_sdk.py         -- Main SDK module
...
The main module (`ipintelligence_sdk`) exports the SDK class.
