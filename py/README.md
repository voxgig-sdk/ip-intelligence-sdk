...
The Python SDK for the IpIntelligence API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.IpIntelligence(None).load(
    {"id": "test01"}, None
)
