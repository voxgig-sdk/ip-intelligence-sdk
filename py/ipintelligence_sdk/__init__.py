...
from ipintelligence_sdk.utility import register

# Load features
from ipintelligence_sdk.feature.base_feature import IpIntelligenceBaseFeature
from ipintelligence_sdk.features import _has_feature, _make_feature
...
class IpIntelligenceSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = IpIntelligenceUtility()
        self._utility = utility

        from ipintelligence_sdk.config import shared_config
    ...
    def get_utility(self):
        return IpIntelligenceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IpIntelligenceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Api(self, data=None) -> "ApiEntity":
        ...
        from ipintelligence_sdk.entity.api_entity import ApiEntity
        return ApiEntity(self, data)


    def Usage(self, data=None) -> "UsageEntity":
        """Entity factory: client.Usage().list() / client.Usage().load({"id": ...})."""
        from ipintelligence_sdk.entity.usage_entity import UsageEntity
