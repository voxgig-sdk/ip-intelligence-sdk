...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ip-intelligence` | `npm install @voxgig-sdk/ip-intelligence` |
| Python | `voxgig-sdk-ip-intelligence` | `pip install voxgig-sdk-ip-intelligence` |
| PHP | `voxgig-sdk/ip-intelligence` | `composer require voxgig-sdk/ip-intelligence` |
| Golang | `github.com/voxgig-sdk/ip-intelligence-sdk/go` | `go get github.com/voxgig-sdk/ip-intelligence-sdk/go` |
| Ruby | `voxgig-sdk-ip-intelligence` | `gem install voxgig-sdk-ip-intelligence` |
| Lua | `voxgig-sdk-ip-intelligence` | `luarocks install voxgig-sdk-ip-intelligence` |
