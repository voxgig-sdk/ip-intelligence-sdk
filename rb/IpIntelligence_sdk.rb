...
require_relative 'IpIntelligence_types'
...
class IpIntelligenceSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = IpIntelligenceHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = IpIntelligenceHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, IpIntelligenceFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    IpIntelligenceUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = IpIntelligenceHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = IpIntelligenceHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = IpIntelligenceHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    rescue IpIntelligenceError => err
    ...
    if fetched.is_a?(Hash)
      status = IpIntelligenceHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = IpIntelligenceError.new(
        "graphql_error", "IpIntelligenceSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = IpIntelligenceSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
