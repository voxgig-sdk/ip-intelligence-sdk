...
#      offline in seeded test mode (IpIntelligenceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IpIntelligence_sdk.rb")
  SDK_CLASS = "IpIntelligenceSDK"
